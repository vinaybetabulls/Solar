...
class PanelBatteryTypes extends Component {
    constructor(props) {
        super(props);
        this.state = {
            validationOne: false,
        ...
        if (roofArea > 400) {
            ...
            this.panelsArray = [
                ...
                { packet: this.state.selectedPacket, count: this.props.packetName == 'Custom paket' ? parseInt(this.props.packetsCount) : this.state.customPacket }
            ]
    ...
    render() {
        return (<div>
            <div className="">
                <h3 className="roof_subhead">Byt produkt</h3>
            </div>
            <div className="">
            ...
            <div className="col-sm-12 estimate" style={{ textAlign: 'center', padding: '30px' }} >
                <div className="flex justifyCenter">
                    ...
                    <div className="padding1">
                        <button onClick={this.props.closeModal} className="submit">Avbryt</button>
                    </div>
                </div>
            </div>
        </div>
...
export default PanelBatteryTypes;